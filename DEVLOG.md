...
- **E2E (Playwright/Chromium, mock 모드)**: `npm test` → **22/22 통과, 콘솔 에러 0**
  - 렌더 / KPI 집계(7) / 입원·병동 네비·보드·필터 / **입원 등록·퇴원** / 환자 전환 / 탭4 / 테마 / 검색 / 정렬 / 노트 CRUD / 처방 CRUD / 척도 CRUD / 검사 CRUD
